...
public class BiteChopComponent implements ServerTickingComponent {

    private final World obj;
    private final List<Tree> treesToCut = new ArrayList<>();
    public BiteChopComponent(World obj){
        this.obj = obj;
    }
    @Override
    public void serverTick() {for (int i = treesToCut.size() - 1; i >= 0; i--) {
