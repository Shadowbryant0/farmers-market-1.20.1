...
public class GearShifted extends SweeplessSword {
    ...
    public ItemStack finishUsing(ItemStack stack, World world, LivingEntity user) {
        ...
        if(stack.hasEnchantments()) {
            ...
            SWORD_ANVIL = stack.getRepairCost();
            HOE_ANVIL = stack.getOrCreateNbt().getInt("hoe_anvil");
            System.out.println("Sword cost:" + SWORD_ANVIL);
            System.out.println("hoe cost:" + HOE_ANVIL);
            newstack.getOrCreateNbt().putInt("sword_anvil", SWORD_ANVIL);
            newstack.setRepairCost(HOE_ANVIL);
