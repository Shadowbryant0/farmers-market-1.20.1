...
public class EnderManPendent extends TrinketItem {
    public EnderManPendent(Settings settings) {
        super(settings);
    }
    public Multimap<EntityAttribute, EntityAttributeModifier> getModifiers(ItemStack stack, SlotReference slot, LivingEntity entity, UUID uuid) {
        ...
        // +15% attack dmg
        modifiers.put(EntityAttributes.GENERIC_ATTACK_DAMAGE, new EntityAttributeModifier(uuid, "farmersmarket:attackspeed", 0.1, EntityAttributeModifier.Operation.MULTIPLY_TOTAL));
        // +10% Armor Toughness
        ...
        // -10% Armor
        modifiers.put(EntityAttributes.GENERIC_ARMOR, new EntityAttributeModifier(uuid, "farmersmarket:armor", 0.3, EntityAttributeModifier.Operation.MULTIPLY_TOTAL));
        // -10% Armor Toughness
    ...
    public static ItemStack getTrinket(LivingEntity livingEntity) {
        ...
        if (component.isPresent()) {
            for (Pair<SlotReference, ItemStack> pair : component.get().getAllEquipped()) {
                if (pair.getRight().getItem() instanceof EnderManPendent) {
